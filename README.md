        ...
        <tr>
            ...
            <td>
                ...
                <li>Воспроизведение бейзлайна: тонкая настройка модели RuBERT base conversational для классификации пары предложений:
                    <ul>
                      <li clalss="circle">1) Вопрос «Как относятся к X?» где Х — сущность в дательном падеже;</li>
                      <li clalss="circle">2) Текст предложения.</li>
                    </ul>
              </li>     
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <li>Предшествующие исследования:
                    <ul>
                        <li clalss="circle">графовый подход,</li>
                        <li clalss="circle">разметка последовательности.</li>
                    </ul>
                </li>
                <li>Соревнование RuOpinionNE-2024:
                    <ul>
                        <li clalss="circle">постановка задачи,</li>
                        <li clalss="circle">анализ датасета,</li>
                        <li clalss="circle">метрики.</li>
                    </ul>
                    </li>
