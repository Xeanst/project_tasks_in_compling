    ...
    <th>Материалы</th>
        ...
        <tr>
            ...
            <td>
                ...
                <li>Воспроизведение бейзлайна: тонкая настройка модели RuBERT base conversational для классификации пары предложений:</li>
                    <ul><li>1) Вопрос «Как относятся к X?» где Х — сущность в дательном падеже;</li>
                    <li></li>2) Текст предложения.</li>
                    </ul>
            </td>
            <td>
